<?php
    ...
    if (isset($_POST['id']) && !empty($_POST['id']) &&
        ...
        isset($_POST['adressePostale']) && !empty($_POST['adressePostale'])) {
            ...
            $gestionnaire = new Gestionnaire($id, $nom, $prenom, $adressePostale, "", "", "", $telephone, $email, $identifiant, $motDePasse, 2, $_SESSION['idUtilisateur']);
            $gestionnaireDAO = new DAOGestionnaire();

            $gestionnaireDAO->updateGestionnaire($gestionnaire);
