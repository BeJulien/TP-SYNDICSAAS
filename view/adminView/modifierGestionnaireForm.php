...
<!-- TODO: Récupérer valeur de base du gestionnaire-->
<div class="row mx-auto">
	...
	<div class="col-md-6 col-sm-4 mx-auto mx-auto">
		<div class="w-50 h-75 mt-5">
			<div class="bg-warning"> Liste des copropriétés à gérer&nbsp;&nbsp;<i class="fas fa-lg fa-plus text-success"></i>&nbsp;&nbsp;<i class="fas fa-lg fa-minus text-secondary"></i></div>
